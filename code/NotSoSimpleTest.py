...
class Test(AbstractTest):
    ...
    def test_getDisksContainingTheMostData(self):
        ...
        self.assertListEqual([2, 1, 3], Solution.getDisksContainingTheMostData(),
                             "size of 2 is 5, size of 1 is 3, 3 is 0")
        self.assertEqual(ReturnValue.OK, Solution.removePhotoFromDisk(Photo(1, "stuff", 3), 1), "Should work")
        self.assertListEqual([2, 1, 3], Solution.getDisksContainingTheMostData(),
                             "size of 2 is 5, size of 1 is 0, 3 is 0")
        self.assertEqual(ReturnValue.OK, Solution.deletePhoto(Photo(2, "stuff", 5)), "Should work")
        self.assertListEqual([1, 2, 3], Solution.getDisksContainingTheMostData(),
        ...
        self.assertListEqual([4, 1, 2], Solution.getDisksContainingTheMostData(),
                             "size of 2 is 0, size of 1 is 0, 3 is 0")
